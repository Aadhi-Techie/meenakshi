...
export default function About({ go, t }) {
  ...
  const featuresData = [
    { icon: <Award size={24} color="var(--o)" aria-hidden="true" />, title: isTamil ? "ISI சான்றளிக்கப்பட்ட பொருட்கள்" : "ISI Certified Materials", desc: isTamil ? "ஒவ்வொரு பொருளும் தரப்பரிசோதனை செய்யப்பட்டு பெறப்படுகிறது." : "Every product quality-checked and sourced from certified manufacturers." },
    { icon: <Handshake size={24} color="var(--o)" aria-hidden="true" />, title: isTamil ? "தனிப்பயனாக்கப்பட்ட சேவை" : "Personalised Service", desc: isTamil ? "அளவீடு முதல் டெலிவரி வரை, எங்கள் நிபுணர்கள் உங்களுடன் இருப்பார்கள்." : "From measurement to delivery, our experts are with you at every step." },
    { icon: <Zap size={24} color="var(--o)" aria-hidden="true" />, title: isTamil ? "அதிவேக டெலிவரி" : "Fastest Delivery", desc: isTamil ? "சென்னை முழுவதும் அன்றே டெலிவரி; வெளியூர்களுக்கு 24 மணி நேரத்திற்குள்." : "Same-day delivery across Chennai; outstation within 24 hours." },
    { icon: <ShieldCheck size={24} color="var(--o)" aria-hidden="true" />, title: isTamil ? "வெளிப்படையான விலை" : "Transparent Pricing", desc: isTamil ? "மறைமுக கட்டணங்கள் இல்லை. மொத்த ஆர்டர்களுக்கு சிறந்த தள்ளுபடி." : "No hidden charges. Best market rates with volume discounts." }
  ];
          ...
          >
            <div style={{ height: 280, position: "relative" }}>
              <img
                ...
                onError={(e) => { e.target.onerror = null; e.target.src = "/assets/hero-bg.jpg"; }}
        ...
        <div style={{ flex: "1 1 500px", animation: "fadeUp 1s ease forwards" }}>
          ...
          <div style={{ display: "flex", gap: 12, flexWrap: "wrap", marginBottom: 24 }}>
            ...
            <div style={{ display: "inline-flex", alignItems: "center", gap: 6, padding: "6px 14px", background: "rgba(234, 179, 8, 0.1)", border: "1px solid rgba(234, 179, 8, 0.2)", borderRadius: 100, color: "#eab308", fontSize: 12, fontWeight: 700 }}>
              <Star size={14} fill="#eab308" aria-hidden="true" /> {isTamil ? "5* கூகுள் ரேட்டிங்" : "5.0 ⭐ Google Reviews"}
            </div>
          </div>
          ...
          <p style={{ color: "var(--sl3)", fontSize: 16, lineHeight: 1.8, marginBottom: 40 }}>
            {t.abP || (isTamil ?
              "சென்னை பெரம்பூரில் கடந்த 20 ஆண்டுகளுக்கும் மேலாக தரமான கட்ஸ்ட்ரக்ஷன் மற்றும் இன்டீரியர் பொருட்களை வழங்கி வரும் முன்னணி நிறுவனம். வாடிக்கையாளர்களுக்கு சிறந்த சேவையை அசல் தயாரிப்புகள் மூலம் வழங்குவதே எங்களின் முதன்மை நோக்கம்." :
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(220px, 1fr))", gap: 20, marginBottom: 40 }}>
            {featuresData.map((feat, i) => (
              <div
                ...
                onMouseMove={handleMouseMove}
                onMouseLeave={handleMouseLeave}
                style={{ background: "rgba(255,255,255,0.02)", border: "1px solid rgba(255,255,255,0.05)", padding: 24, borderRadius: 16, transition: "transform 0.1s ease-out", transformStyle: "preserve-3d", cursor: "default" }}
              >
